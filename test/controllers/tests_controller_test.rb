...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { email: @test.email, memo: @test.memo, password: @test.password } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { email: @test.email, memo: @test.memo, password: @test.password } }
